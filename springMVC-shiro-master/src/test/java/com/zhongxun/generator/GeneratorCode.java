package com.zhongxun.generator;
...
import com.zhongxun.commons.generator.AutoGenerator;
import com.zhongxun.commons.generator.InjectionConfig;
...
//        strategy.setInclude(new String[] { "order_shop_detail" }); // 需要生成的表
        ...
        // 自定义 controller 父类
         strategy.setSuperControllerClass("com.zhongxun.commons.base.BaseController");
