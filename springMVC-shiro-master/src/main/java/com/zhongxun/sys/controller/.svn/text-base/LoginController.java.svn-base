...
import com.zhongxun.commons.csrf.CsrfToken;
import com.zhongxun.commons.utils.CaptchaUtils;
...
public class LoginController extends BaseController {
   ...
   /**
    ...
    public String baseTemplate(String id,Model model) {
        model.addAttribute("id",id);
        return "base/baseTemplate";
    }
